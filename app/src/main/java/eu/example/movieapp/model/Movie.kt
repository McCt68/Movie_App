package eu.example.movieapp.model

// class for creating movie objects, so we can represent each movie as an object
data class Movie(
	val id: String,
	val title: String,
	val year: String,
...
// function returns a list of Movie objects
// I think this representation is similar to how a Json file would look ??
// So each Movie is an object represented in Json format, which has id, title, year an so on...
